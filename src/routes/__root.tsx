...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Aether Journeys curates immersive luxury travel experiences across the world's most extraordinary destinations." },
      { name: "author", content: "Aether Journeys" },
      { property: "og:title", content: "Aether Journeys — Travel Beyond Destinations" },
      { property: "og:description", content: "Curated luxury journeys designed for unforgettable experiences." },
